            ...
            <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-blue-600">
                    {subjects.map((subject, index) => (
                        <tr key={index}>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{subject.extern_code}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{subject.extern_name}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{subject.intern_code}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{subject.intern_name}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
            ...
            {modal && (
                <Modal setModal={() => setModal(false)}>
                    <div className="space-y-2">
                        ...
                        <button onClick={() => { addSubject(); setModal(false); }}>Agregar</button>
                    </div>
                </Modal>
            )}

    ...
    return (
        <div className="w-full flex flex-col items-center mt-4">
            ...
            <div className="w-full">
                <table className="table-auto w-full border-collapse border border-slate-500 bg-white shadow-md rounded-lg">
                    <thead className="bg-darkGreen text-white">
                        <tr>
                            <th className="px-6 py-3 text-left font-semibold">Solicitante</th>
                            <th className="px-6 py-3 text-left font-semibold hidden sm:table-cell">Email</th>
                            <th className="px-6 py-3 text-left font-semibold">Solicitud</th>
                            <th className="px-6 py-3 text-left font-semibold hidden sm:table-cell">Fecha de solicitud</th>
                            ...
                            votings
                                ...
                                .map((voting: Voting) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 border-b border-gray-300 hidden sm:table-cell">{voting.user_application.user.email}</td>
                                        <td className="px-6 py-4 border-b border-gray-300">{voting.user_application.application.name}</td>
                                        <td className="px-6 py-4 border-b border-gray-300 hidden sm:table-cell">{new Date(voting.user_application.created_at).toLocaleDateString()}</td>
